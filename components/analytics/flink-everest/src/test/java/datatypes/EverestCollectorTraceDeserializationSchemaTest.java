...
/** 
* EverestCollectorTraceDeserializationSchema Tester. 
* 
* @author Indra G Harijono
* @since <pre>Jun 18, 2019</pre> 
* @version 1.0 
*/ 
public class EverestCollectorTraceDeserializationSchemaTest { 
...
/** 
* 
* Method: serialize(EverestCollectorTrace everestCollectorTrace) 
* 
*/ 
@Test
...
/** 
* 
* Method: isEndOfStream(EverestCollectorTrace nextElement) 
* 
*/ 
@Test
