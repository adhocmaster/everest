 ...
 */
public class CustomWatermarkExtractor implements AssignerWithPeriodicWatermarks<KafkaEvent<String, Double, Double>> {
    ...
    @Override
    public long extractTimestamp(KafkaEvent<String, Double, Double> event, long previousElementTimestamp) {
